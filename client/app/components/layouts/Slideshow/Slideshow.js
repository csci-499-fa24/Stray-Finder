    ...
    <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel" >
      ...
      <div className="carousel-inner" style = {{width : '100vw'}}>
        ...
        <div className="carousel-item">
          <img src="/stray5.webp" className="d-block w-100" alt="Second Slide" slide = {{width : '100vw'}}/>
          <div className="carousel-caption d-none d-md-block">
        ...
        {/* Slide 3 */}
        <div className="carousel-item">
          <img src="/stray4.webp" className="d-block w-100" alt="Third Slide" slide = {{width : '100vw'}}/>
          <div className="carousel-caption d-none d-md-block" >
            <h5>Found a Stray?</h5>
